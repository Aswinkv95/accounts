package com.Micro1Accounts.Controller;
...
import com.Micro1Accounts.dto.ErrorResponseDto;
import com.Micro1Accounts.dto.ResponseDto;
...
private IAccountsService iAccountsService;
    ...
    @PutMapping("/delete")
    public ResponseEntity<ResponseDto> deleteAccount(@Pattern(regexp = "^\\d{10}$", message = "Mobile Number should be 10 digits")
                                                          String mobileNumber) {
